...
namespace TheDashboard.Clients
{
    ...
    public partial class TileDto
    {
        ...
        public static TileDto FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<TileDto>(data, new Newtonsoft.Json.JsonSerializerSettings());
