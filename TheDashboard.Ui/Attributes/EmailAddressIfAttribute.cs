...
public sealed class EmailAddressIfAttribute : ValidationAttribute
{
  #region Properties
  ...
  public EmailAddressIfAttribute(string otherProperty, object otherPropertyValue)
  ...
  protected override ValidationResult IsValid(object value, ValidationContext validationContext)
  {
        ...
        IsInverted && !Equals(otherValue, OtherPropertyValue))
    {
      ...
      // additional check for strings so they're an email
      string val = value as string;
      if (val != null && val.Trim().Length == 0)
      {
        return IsValidEmail(val) ? ValidationResult.Success : new ValidationResult(FormatErrorMessage(validationContext.DisplayName));
      }
    }
